...
import HotelRoomCard from "../../share/cards/HotelRoomCard.jsx";
import FilterGroup from "../filter/FilterGroup.jsx";
import { filterByRoomType } from "../filter/ultils/index.js";
...
export default function AllRooms() {
  ...
  const filterRoom = roomsDummyData.filter((room) => {
    return filterByRoomType(room, filters.roomTypes);
  });
  ...
  return (
    <PageWrapper>
      ...
      <div className="mx-auto my-6 w-full md:w-[180px]">
        <button className="w-full h-[50px] bg-blue-500 hover:bg-blue-600 text-white rounded-lg px-4 py-2 text-center transition duration-200 text-sm md:text-base">
          Show More
        </button>
      </div>
    </PageWrapper>
